     ...
     <legend>Please, enter your user and password for login.</legend>
		<table style="with: 50%">
          ...
          <div class="input-block">
			<tr>
				<td>UserName</td>
				<td><input type="text" name="username" / id="signup-email"></td>
			</tr>
		  </div>
		   <div class="input-block">
				<tr>
				<td>Password</td>
				<td><input type="password" name="password" / id="signup-password"></td>
			</tr>
		</fieldset>
		 <div class="input-block">
		 
		</table>
		<br/><input type="submit" value="Login" / class="btn-login"></form>
		   
         <br/><font  color="green"><b><h5> If you haven't an account </h5></b></font> <button  class="btn-login"><a href="Register.jsp">Sign Up</a></button>
